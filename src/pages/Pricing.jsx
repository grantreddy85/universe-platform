...
const PLANS = [
  {
    ...
    description: "Full platform access in exchange for active, validated data contribution. Your data trains the UniVerse Model — and earns you credits every time it's used.",
    color: "border-emerald-200 bg-emerald-50/30",
    badge: "bg-emerald-100 text-emerald-700",
    icon: Database,
    iconColor: "text-emerald-600",
    requirement: "1 upload/30d · 1 validated asset/60d",
    credits: "Credits earned by contributing",
    features: [
